...
The general syntax for an if statement comes in two forms: <br>
```
if CODE_IF_TRUE ;
...
One error that can occur with if statements is the error: <br>
```
If statement error:
...
To fix this, have a Boolean type at the top of the stack for branching to occur. <br>
...
the interpreter will error out as if it were a gibberish word or a comment wasn't ended properly. <br>

#### Examples
Correct comment: ```/' This is a valid comment! '/``` <br>
Incorrect comments: <br>
``` 
...
All of these incorrect comments will cause an ```unrecognized word``` or <br>
